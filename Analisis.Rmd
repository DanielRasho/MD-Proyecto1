...
cuantitative_variables$castWomenAmount <- as.numeric(movies$castWomenAmount)
cuantitative_variables$castMenAmount <- as.numeric(movies$castMenAmount)
...
categorical_vars <- movies[, c("genres", "homePage", "productionCompany", "productionCompanyCountry","productionCountry", "director", "originalTitle", "title", "originalLanguage" , "releaseDate")]

# Function to generate a frequency table for each categorical variable
print_frequency_tables <- function(data) {
  for (var in colnames(data)) {
    ...
    # Order by Frequency in descending order (closing parenthesis added here)

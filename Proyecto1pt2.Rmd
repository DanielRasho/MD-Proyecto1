...
```{r data without string, echo=FALSE, message=FALSE, error=FALSE}
...
Se puede observar que en la grafica por los valores 2 - 4 se empieza a doblar el grafica por lo que al probar por medio de varias iteraciones logramos encontrar que para k means el mejor numero de grupos es 2.

```{r k medias, echo=FALSE}
